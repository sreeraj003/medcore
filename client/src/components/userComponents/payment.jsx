...
function Payment() {
    ...
    return (
        <div className="mx-auto slice w-75 mt-5 p-5 app-div">
                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 mt-5 text-center">
                                <button className='btn text-dark btn-outline-success' onClick={handlePay}>Pay</button> <button className='btn text-dark btn-outline-success'>Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
